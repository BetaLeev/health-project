...
var AtInput = function (_AtComponent) {
  ...
  function AtInput() {
    ...
    var _this = _possibleConstructorReturn(this, (AtInput.__proto__ || Object.getPrototypeOf(AtInput)).apply(this, arguments));

    _this.$usedState = ["anonymousState__temp", "rootCls", "containerCls", "overlayCls", "title", "required", "name", "type", "password", "placeholderStyle", "placeholderCls", "placeholder", "cursorSpacing", "maxLength", "autoFocus", "focus", "value", "confirmType", "cursor", "selectionStart", "selectionEnd", "adjustPosition", "clear", "error", "className", "customStyle", "border", "placeholderClass", "editable", "children"];
...
AtInput.$$events = ["handleClick", "handleInput", "handleFocus", "handleBlur", "handleConfirm", "handleKeyboardHeightChange", "handleClearValue", "handleErrorClick"];
AtInput.$$componentPath = "Users/vlee/Desktop/healthApp/node_modules/taro-ui/dist/weapp/components/input/index";
