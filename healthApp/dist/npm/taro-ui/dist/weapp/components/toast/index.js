...
var AtToast = function (_AtComponent) {
  ...
  function AtToast() {
    ...
    var _this = _possibleConstructorReturn(this, (AtToast.__proto__ || Object.getPrototypeOf(AtToast)).apply(this, arguments));

    _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "_isOpened", "hasMask", "bodyClass", "realImg", "isRenderIcon", "iconClass", "text", "customStyle", "icon", "status", "image", "className", "isOpened", "duration"];
...
AtToast.$$componentPath = "Users/vlee/Desktop/healthApp/node_modules/taro-ui/dist/weapp/components/toast/index";
